...
from GroupMaster import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from GroupMaster.modules import ALL_MODULES
from GroupMaster.modules.helper_funcs.chat_status import is_user_admin
from GroupMaster.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("GroupMaster.modules." + module_name)
